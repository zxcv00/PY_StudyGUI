...
btn_f16.grid(row = 0, column = 0, sticky = "news", padx = 3, pady = 3)      # sticky = "news"도 가능
...
btn_enter.grid(row = 4, column = 3, rowspan = 2, sticky = "news", padx = 3, pady = 3)      # 현재 위치로부터 이래 쪽으로 몇 줄을 더 함

# 0 시작 줄
btn_0 = Button(root, text = "0", width = 5, height = 2)
btn_point = Button(root, text = ".", width = 5, height = 2)

btn_0.grid(row = 5, column = 0, columnspan = 2, sticky = "news", padx = 3, pady = 3)         # 현재 위치로부터 오른쪽으로 몇 칸 더함
